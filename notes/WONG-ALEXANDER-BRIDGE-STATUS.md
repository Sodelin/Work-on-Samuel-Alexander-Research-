...
acyclicity; interval-table normalization remains separate.
...
| 5 | Selected simplification rewrites | Retained-node contraction and its composition with sample resolution are checked. Full finite-interval output and individual software rewrite algorithms remain separate. |
